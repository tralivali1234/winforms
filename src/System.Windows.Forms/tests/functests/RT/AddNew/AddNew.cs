...
[assembly: System.Security.AllowPartiallyTrustedCallers]    // Required for security tests
public class TestAddNew : ReflectBase
{
    ...
    void InitDataAllowNewFalse(int rows)
    {
        ...
        {
            dt.Rows.Add(TestAddNew.scenarioParams.ru.GetString(50), TestAddNew.scenarioParams.ru.GetString(50), TestAddNew.scenarioParams.ru.GetString(50), TestAddNew.scenarioParams.ru.GetString(50), TestAddNew.scenarioParams.ru.GetString(50));
        }
...
// [Scenarios]
//@ AddNew from first row.
//@ AddNew from first row, AllowNew=false
//@ AddNew from last row.
//@ AddNew from last row, AllowNew=false
//@ AddNew from random middle row.
//@ AddNew from random middle row, AllowNew=false.
//@ AddNew from empty data source
//@ AddNew from empty data source, AllowNew=false
//@ AddNew with DataSource = dataset, DataMember = null
