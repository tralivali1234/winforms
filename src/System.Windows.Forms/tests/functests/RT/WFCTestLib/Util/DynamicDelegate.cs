...
namespace WFCTestLib.Util
{
    ...
    public class DynamicDelegate
    {
        ...
        public static EventHandlerRef AddHandler(object source, EventInfo eventToAttach, DelegateHandler target)
        {
            ...
            AssemblyBuilder _AssemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(Guid.NewGuid().ToString()), AssemblyBuilderAccess.Run);
            //AssemblyBuilder _AssemblyBuilder = AppDomain.CurrentDomain.DefineDynamicAssembly(new AssemblyName("DynamicAssembly"), AssemblyBuilderAccess.RunAndSave);
