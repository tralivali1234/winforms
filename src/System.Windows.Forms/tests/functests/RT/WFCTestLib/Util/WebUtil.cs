...
namespace WFCTestLib.Util
{
    ...
    public struct WebPage
    {
        ...
        private static string SERVER_NAME = Utilities.GetServerName("ASPNET").ToLower();
        public static string ServerName
        { get { return SERVER_NAME; } }
        private static string SERVER_FQDN = Utilities.GetServerName("ASPNET").ToLower() + ".redmond.corp.microsoft.com";
